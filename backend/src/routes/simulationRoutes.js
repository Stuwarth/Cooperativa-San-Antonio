...
import { simulateWanFailure, simulateEmiNoise, simulateDdosAttack, simulateLinkCut, restoreAll, getSystemStatus } from '../controllers/simulationController.js';
...
router.post('/link-cut', simulationLimiter, simulateLinkCut);
